	...
	private final EmailService emailService;
	 ...
	 public Medico cadastrar(Medico medico) {
	     ...
	     email.setBodyHtml(
	         ...
	         "<img src='https://static.wixstatic.com/media/8307fe_1369d46f63cc4b69b79cfb4259243571~mv2.jpg/v1/fill/w_1000,h_670,al_c,q_85,usm_0.66_1.00_0.01/8307fe_1369d46f63cc4b69b79cfb4259243571~mv2.jpg' width='300'/>" +
	         "</div>" +
	         "<div class='content'>" +
		...
		/*
		 * @Override public Medico cadastrar(Medico medico) { Medico medicoSalvo =
		 * repository.save(medico);
		 * 
		 * EmailRequestDTO email = new EmailRequestDTO();
		 * email.setSmtpHost("smtp.gmail.com"); email.setSmtpPort(587);
		 * email.setSmtpUsername("pphenriquelim4@gmail.com");
		 * email.setSmtpPassword("vhsb ygkq gvza vlmp");
		 * email.setFrom("pphenriquelim4@gmail.com"); email.setTo(medico.getEmail());
		 * email.setSubject("Cadastro confirmado"); email.setBodyHtml( "<!DOCTYPE html>"
		 ...
		 * "<div class='content'>" + "<h2>Olá Dr(a). " + medico.getNome() + ",</h2>" +
		 * "<p>Seu cadastro foi concluído com sucesso em nosso sistema.</p>" +
		 * "<p>Agora você pode acessar a plataforma e acompanhar suas consultas.</p>" +
		 * "<a href='https://seusistema.com/login' class='button'>Acessar Sistema</a>" +
		 * "</div>" +
